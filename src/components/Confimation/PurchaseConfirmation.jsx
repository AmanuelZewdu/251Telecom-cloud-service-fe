...
const PurchaseConfirmation = () => {
  ...
  return (
    <div className="bg-gray-100 font-montserrat h-svh">
      <div className="flex top-[5em] flex-wrap justify-center relative p-4 w-full">
        <div className="grow max-w-[40em] flex items-center justify-center p-2">
          <div className="flex flex-col gap-3 border-2 w-full rounded-md p-4 bg-white drop-shadow-md">
            ...
            <Button variant="contained">Pay with EtSwitch</Button>
          </div>
        </div>
