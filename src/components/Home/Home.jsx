...
const Home = () => {
  return (
    <div className="home-wrapper relative bg-no-repeat bg-cover bg-center flex items-center justify-center h-screen -mt-[5em] md:-mt-[4em]">
      <div className="absolute bg-black opacity-50 inset-0"></div>
      <div className="relative flex flex-col gap-4 text-white p-2 my-7 text-center items-center">
        <h1 className="text leading-10 text-2xl font-semibold">
